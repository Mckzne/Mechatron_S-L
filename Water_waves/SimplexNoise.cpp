...
// Full 512-entry permutation table
...
float SimplexNoise::noise(float xin, float yin) {
  ...
  n0 = t0<0 ? 0.0f : t0*t0*t0*t0*dot(grad3[gi0], x0, y0);

  float t1 = 0.5f - x1*x1 - y1*y1;
  n1 = t1<0 ? 0.0f : t1*t1*t1*t1*dot(grad3[gi1], x1, y1);

  float t2 = 0.5f - x2*x2 - y2*y2;
  n2 = t2<0 ? 0.0f : t2*t2*t2*t2*dot(grad3[gi2], x2, y2);
